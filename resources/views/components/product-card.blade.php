...
<div class="w-full h-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
    <div class="flex justify-center items-center">
        <a href="#">
            <img class="p-8 h-full w-full rounded-t-lg " src={{ $image }} alt="product image" />
        </a>
    </div>
    <div class="px-5 pb-5 ">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="/products/{{ $id }}/edit" class="font-semibold text-indigo-600 hover:text-indigo-500 mr-4">Edit</a>
                @endif
                @endauth
                <div class="">
                    <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2.5 text-center">Add to cart</a>
                </div>
            </div>
        </div>
    </div>
